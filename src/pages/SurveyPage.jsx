...
const SurveyPage = () => {
  ...
  return (
    <S.Wrapper>
      ...
      <ProgressBarContainer cur={1} max={10} />
      <S.Title>해당 상품 가입 목적이 무엇입니까?</S.Title>
      <RadioGroup />
      ...
      >
        <S.ButtonText>당신의 직업은 무엇인가요?</S.ButtonText>
        <ArrowDown />
      </S.SheetButton>
      ...
      <S.ButtonWrapper>
        ...
        <S.Button onClick={() => navigate("/survey2")}>다음</S.Button>
      </S.ButtonWrapper>
    </S.Wrapper>
  );
};
