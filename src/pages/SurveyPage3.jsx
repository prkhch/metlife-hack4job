...
import RadioGroup from "../components/radio3/RadioGroup";
...
const SurveyPage = () => {
  ...
  return (
    <S.Wrapper>
      ...
      <ProgressBarContainer cur={3} max={10} />
      <S.Title>당신의 월소득 구간은 어떻게되나요?</S.Title>
      <RadioGroup />
      ...
      <S.ButtonWrapper>
        ...
        <S.Button onClick={() => navigate("/survey4")}>다음</S.Button>
      </S.ButtonWrapper>
    </S.Wrapper>
  );
};
