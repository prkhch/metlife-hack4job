...
import RadioGroup from "../components/radio4/RadioGroup";
...
const SurveyPage = () => {
  ...
  return (
    <S.Wrapper>
      ...
      <ProgressBarContainer cur={4} max={10} />
      <S.Title>당신의 성별은 무엇인가요?</S.Title>
      <RadioGroup />
      ...
      <S.ButtonWrapper>
        ...
        <S.Button onClick={() => navigate("/survey5")}>다음</S.Button>
      </S.ButtonWrapper>
    </S.Wrapper>
  );
};
