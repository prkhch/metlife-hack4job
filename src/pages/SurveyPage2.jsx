...
import RadioGroup from "../components/radio2/RadioGroup";
...
const SurveyPage = () => {
  ...
  return (
    <S.Wrapper>
      ...
      <ProgressBarContainer cur={2} max={10} />
      <S.Title>당신의 연령은 어떻게 되나요?</S.Title>
      <RadioGroup />
      ...
      <S.ButtonWrapper>
        ...
        <S.Button onClick={() => navigate("/survey3")}>다음</S.Button>
      </S.ButtonWrapper>
    </S.Wrapper>
  );
};
